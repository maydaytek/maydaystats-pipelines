"""Load a Statcast DataFrame into BigQuery, creating the dataset if needed.

Table schema is auto-detected from the DataFrame on first load and allowed
to grow (ALLOW_FIELD_ADDITION) since Baseball Savant occasionally adds new
Statcast columns season over season.
"""
...
def load_dataframe(
    ...
    """Append a DataFrame of Statcast rows into the target table, skipping
